...
public class Type {
    ...
    public static GenericChartItemType getGenericChartItemType(ChartItemType chartItemType) {
        switch (chartItemType) {
            ...
            case YAXISCOMBINE_CHART_FUSION:
                return FUSION_CHART_VERTICAL_GROUP2;
            case LINESERIES_CHART_FUSION:
                return LINESERIES_FUSION_CHART2;
    ...
    public enum GenericChartItemType {
        BAR_CHART, DRILL_DOWN_CHART, LINE, TABLE, BAR_GAUGE_CHART, NONE, AGGREGATE,FUSION_CHART,FUSION_CHART2,FUSION_CHART_VERTICAL_GROUP,FUSION_CHART_VERTICAL_GROUP2,LINESERIES_FUSION_CHART2;
    }
    ...
    public enum ChartItemType {
        ...
        DATA_GRID("data-grid"),
        LINESERIES_CHART_FUSION("lineseries-chart-fusion"),
        YAXISCOMBINE_CHART_FUSION("yaxiscombine-chart-fusion");
